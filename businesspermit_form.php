     ...
     ?> 
       ...
       <div style="width: 100%; height:100%; max-height: 1000px;">
                ...
                background-repeat: no-repeat; background-position: center; background-size: 80%; background-color: rgba(255, 255, 255, 0.9); background-blend-mode: overlay; background-position: center top; height: 800px;">
                        ...
                        <p class="print-padding"  style="text-indent: 40px;text-align: justify;">Applied to operate a <b><u><?= $resident['bsname'];?></u></b> with business address at <b><u><?= $resident['houseno'];?> <?= $resident['street'];?>, Brgy. Canlubang, Calamba, Laguna</b></u>.</b></p>


                        <p class="print-padding" style="text-indent: 40px;text-align: justify;">This further certifies that the said business is not violating any of the provisions of RA 7160 and the Local Revenue Code of the Municipality of Canlubang, Calamba, Laguna. That the said business will not adversely affect public order, health, condition, safety, convenience, comfort, interest and the general, welfare in the area.</p>
...
?>
                        <p class="print-padding" style="text-indent:40px;text-align: justify;">Given this <ins><?= date('jS');?></ins> day of <ins><?= date('F');?></ins>, 2024, here at Barangay Calumbang, Calamba City, Laguna, Philippines, for whatever legal purpose it may serve.</p>
                        ...
                        <div style="display: flex;">
                            ...
                            <div style="flex: 1;"><br>
                                ...
                                <label style="margin-left:1em; margin-top: 10px;"><u>HON. QUINTIN J. ROMERO</u></label><br>
                ...
                <div class="col-xs-8 col-md-4"> 
                    ...
                    <b><span style=" text-align: center;">Issued at </b><u>BRGY.CANLUBANG</u></span><br>
