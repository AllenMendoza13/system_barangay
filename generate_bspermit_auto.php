    ...
    <div class="col-xs-12 col-sm-6 col-md-8">
        <div style="width: 100%; height:100%; max-height: 1000px;">
            ...
            <div style="background-image: url('assets/logos.png'); background-size: cover;
                ...
                <p class="print-padding" style="text-indent: 40px;text-align: justify;">Applied to operate a <b><u><?= $bsname; ?></u></b> with business address at <b><u><?= $houseno; ?> <?= $street; ?>, Brgy. Calaocan Santiago City, Isabela</b></u>.</b></p>

                <p class="print-padding" style="text-indent: 40px;text-align: justify;">This further certifies that the said business is not violating any of the provisions of RA 7160 and the Local Revenue Code of the Municipality of Santiago City, Isabela. That the said business will not adversely affect public order, health, condition, safety, convenience, comfort, interest and the general, welfare in the area.</p>
                ...
                ?>
                <p class="print-padding" style="text-indent:40px;text-align: justify;">Given this <ins><?= date('jS'); ?></ins> day of <ins><?= date('F'); ?></ins>, 2024, here at Barangay Calaocan, Santiago City, Isabela, Philippines, for whatever legal purpose it may serve.</p>
