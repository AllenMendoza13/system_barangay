                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                placeholder="Enter case"  style="text-align:left;" required>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Please fill out this field.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                <label> Case respondent: </label>
                                                <input type="text" class="form-control" name="case_respondent"  
                                                placeholder="Enter case respondent"  style="text-align:left;" required>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Please fill out this field.</div>
                                            </div>
                                        </div>
