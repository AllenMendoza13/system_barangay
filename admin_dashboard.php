<?php
if(!isset($_SESSION['admin'])){header('Location: index_login.php');}
...
$farmers = $residentbmis->count_farmers();
?>
...
var chartUrlMapping = {
    ...
    <?php foreach ($ipcommunitycount as $ip): ?>
    '<?= $ip['ip_community'] ?> Members': 'admn_resident_ip.php?community=<?= urlencode($ip['ip_community']) ?>',
    <?php endforeach; ?>
};
