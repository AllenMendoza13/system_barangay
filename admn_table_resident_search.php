                    ...
                    <tr>
                        <td>
                            <form method="post">
                                ...
                                <button class="btn btn-danger" type="submit" name="delete_resident" style="width: 70px; font-size: 14px; border-radius:5px;"> Delete </button>
                                <input type="hidden" id="idresident" name="id_resident" value="<?= $view['id_resident']; ?>">
                                <!-- <a href="javascript:void(0)" onclick="TINY.box.show({ url: 'admn_viewresident.php', height:500,width:900})">Test</a> -->

                            </form>
                        </td>
                        <td>
                            <div style="display: flex; gap: 5px;">
                                <button data-id="<?= $view['id_resident']; ?>" class="btn btn-success residency btn-sm" style="width: 95px; height: 30px; font-size: 14px; border-radius:5px; margin-bottom: 5px; margin-left: auto; margin-right: auto;">Residency</button>
                                <button data-id="<?= $view['id_resident']; ?>" class="btn btn-success business btn-sm" style="width: 95px; height: 30px; font-size: 14px; border-radius:5px; margin-bottom: 5px; margin-left: auto; margin-right: auto;" data-toggle="modal" data-target="#modalBusiness">Business</button>
                                <button data-id="<?= $view['id_resident']; ?>" class="btn btn-success clearance btn-sm" style="width: 95px; height: 30px; font-size: 14px; border-radius:5px; margin-bottom: 5px; margin-left: auto; margin-right: auto;" data-toggle="modal" data-target="#modalClearance">Clearance</button>
                                <button data-id="<?= $view['id_resident']; ?>" class="btn btn-success indigency btn-sm" style="width: 95px; height: 30px; font-size: 14px; border-radius:5px; margin-bottom: 5px; margin-left: auto; margin-right: auto;" data-toggle="modal" data-target="#modalIndigency">Indigency</button>
                            </div>
