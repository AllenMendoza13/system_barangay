...
<html>
    ...
    <body> 
        ...
        <nav class="navbar navbar-dark bg-primary sticky-top">
            <div class="logo">
            <a href="#"><img src="assets/logos.jpg" alt="logo" style="height: 60px; border-radius: 50%;"/></a>
          </div>
            <a class="navbar-brand" href="resident_homepage.php" class="btn3 bg-primary" style="margin-left:10px;"><b>Barangay Calaocan Information System</b></a>
        ...
        <footer id="footer" class="bg-primary text-white d-flex-column text-center">
                        ...
                        <ul class="list-unstyled collapse" id="Contact-Us">
                            <li>
                                <div class="zoom">
                                    ...
                                    <img src="assets/logos.jpg" alt="Person" width="96" height="96" style="border-radius: 50%;">
            ...
            <div class="py-3 text-center">
                ...
                document.write(new Date().getFullYear())
                  ...
                  | Barangay Canlubang Information System
            </div>
