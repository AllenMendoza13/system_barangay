     ...
     ?> 
       ...
       <div style="width: 100%; height:100%; max-height: 1000px;">
                ...
                background-repeat: no-repeat; background-position: center; background-size: 80%; background-color: rgba(255, 255, 255, 0.9); background-blend-mode: overlay; background-position: center top; height: 800px;">
                        ...
                        <p class="print-padding" style="text-indent:40px;text-align: justify;">This is to certify that <b><?= $resident['lname'];?>, <?= $resident['fname'];?> <?= $resident['mi'];?></b>, <b><?= $age['age'];?></b> years old belongs to indigent family of <b><?= $resident['houseno'];?> <?= $resident['street'];?></b>, Barangay Calubang, City of Calamba, Laguna.</p> 
