    ...
    if (isset($_POST['add_resident_admin'])) {
        ...
        try {
            ...
            $stmt = $connection->prepare("INSERT INTO tbl_resident (request_status, lname, fname, mi, contact, email, password, houseno, street, brgy, 
                                                                    municipal, bdate, bplace, s_of_income, occupation, nationality ,psa_holder, psa_correction, ntnlId, 
            ...
            $stmt->execute([$r_status, $lname, $fname, $mi, $contact, $email, $password, $houseno, $street, $brgy, $municipal,
                            $bdate, $bplace, $soi, $occupation, $nationality, $psa_holder, $psa_correction, $ntnlid_num, $status, $age,
                            $sex, $voter, $pwd, $indigent, $single_parent, $malnourished, $four_ps, $pregnant, $animals_, $trees_,
                            $farmer_, $veges_, $role, $ip_community, $out_of_school_youth, $lgbtq, $senior, $admin_id]);
    ...
    if (isset($_POST['add_resident'])) {
        ...
        try {
            $stmt = $connection->prepare("INSERT INTO tbl_resident (lname, fname, mi, contact, email, password, houseno, street, brgy, municipal, 
                                                                    bdate, bplace, s_of_income, occupation, nationality ,psa_holder, psa_correction, ntnlId, status, age,
            ...
            $stmt->execute([$lname, $fname, $mi, $contact, $email, $password, $houseno, $street, $brgy, $municipal,
                            $bdate, $bplace, $soi, $occupation, $nationality, $psa_holder, $psa_correction, $ntnlid_num, $status, $age,
                            $sex, $voter, $pwd, $indigent, $single_parent, $malnourished, $four_ps, $pregnant, $animals_, $trees_,
                            $farmer_, $veges_, $role, $request_status, $ip_community, $out_of_school_youth, $lgbtq, $senior]);
        ...
        public function update_resident() {
            if (isset($_POST['update_resident'])) {
                ...
                $ss = $stmt->execute([
                    $lname, $fname, $mi, $age, $sex,
                    $status, $houseno, $street, $contact, $bdate,
                    $bplace, $soi, $occupation, $nationality, $psa,
                    $psa_correction, $ntnlId, $voter, $pwd, $indigent,
                    $single_parent, $malnourished, $four_ps, $pregnancy, $dom_a,
                    $trees, $farmer, $ip_community, $out_of_school_youth,
                    $lgbtq, $senior, $id_admin, $id_resident
                ]);
