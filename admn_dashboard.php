...
<div class="row">
    ...
    <div class="col-md-4"> 
        ...
        <!-- IP Community Cards - One for each community -->
        <?php foreach ($ipcommunitycount as $ip): ?>
        <div class="col-md-4"> 
            <div class="card border-left-primary shadow card-upper-space">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total <?= $ip['ip_community'] ?> Members</div>
                                <div class="h5 mb-0 font-weight-bold text-dark"><?= $ip['count'] ?></div>
                                <br>
                                <a href="admn_resident_ip.php?community=<?= urlencode($ip['ip_community']) ?>"> View Records </a>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-users fa-2x text-dark"></i>
                        </div>
